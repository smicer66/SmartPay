...
<portlet:actionURL var="feeDescriptionEditor" name="processAction">
	<portlet:param name="action"
		value="<%=FEE_DESCRIPTION.UPDATE_FEE_DESCRIPTION.name()%>" />
</portlet:actionURL>

<h2>Update A Transaction Fee</h2>


<div style="padding-left:10px; padding-right:10px">
	<div class="panel  panel-primary">
	  <div class="panel-heading"><span style="color:white; font-weight: bold">Edit A Transaction Fee</span></div>
	  <div class="panel-body">
	    <form  id="feedescriptionform" action="<%=feeDescriptionEditor%>" method="post" enctype="application/x-www-form-urlencoded">
	    <fieldset>
		  ...
		  <div style="padding-bottom:5px"><%=portletState.isPrimaryFeeChecked()!=null && portletState.isPrimaryFeeChecked()==true  ? "This is a primary fee" : ""  %>
	        
	      </div>
	      <div>
	        <input type="submit" name="saveFeeDescription" value="Save Fee Description Details" id="saveFeeDescription" class="btn btn-success" />
