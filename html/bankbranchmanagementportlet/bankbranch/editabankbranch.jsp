...
<portlet:actionURL var="bankbranchcreator" name="processAction">
	<portlet:param name="action"
		value="<%=BANK_BRANCH_ACTION.EDIT_A_BANK_BRANCH.name()%>" />
</portlet:actionURL>
...
<div style="padding:10px; width:900px;">
	...
	<div class="panel panel-info">
	  	...
	  	<div class="panel-heading">Edit A Bank Branch</div>
	    <form  id="editbankbranchform" action="<%=bankbranchcreator%>" method="post" enctype="application/x-www-form-urlencoded">
	    <fieldset>
	    	<div style="padding:10px;">
			    	<legend>Provide the details required</legend>
			      <div> <strong>Bank Branch Name:</strong>
			        <div>
			          <input class="clear" type="text" value="<%=portletState.getBankBranchName()==null ? "" : portletState.getBankBranchName() %>" name="bankbranchname" id="bankbranchname" placeholder="Provide The Bank Branch Name" />
			        </div>
			        </label>
			      </div>
				  <div> <strong>Bank Branch Sort Code:</strong>
			        <div>
			          <input onkeypress="return onlyNumKey(event)" class="clear" type="text" value="<%=portletState.getBankBranchCode()==null ? "" : portletState.getBankBranchCode() %>" name="bankbranchcode" id="bankbranchcode" placeholder="Provide The Bank Branch Code" />
			        </div>
			        </label>
			      </div>
			    ...
			    All fields with red asterisk (*) imply they must be provided</div>
			      <div style="padding-top:20px;">
					<button class="btn btn-success">Save Bank Branch Details</button>
			      </div>
			</div>
	    </fieldset>
	    </form>
