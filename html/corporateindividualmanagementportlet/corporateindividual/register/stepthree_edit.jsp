...
<portlet:actionURL var="proceedToStepTwo" name="processAction">
	<portlet:param name="action"
		value="<%=COMPANY_CREATE_INDIVIDUAL_ACTIONS.UPDATE_AN_INDIVIDUAL_STEP_THREE.name()%>" />
</portlet:actionURL>

<div style="padding:10px; width:900px"> 	
    <div class="panel  panel-primary">
		<div class="panel-heading"><span style="color:white; font-weight: bold">Step 2 of 2: Preview Company Staff Profile Details</span></div>
    ...
    <form  id="startRegFormId" action="<%=proceedToStepTwo%>" method="post" enctype="application/x-www-form-urlencoded">
    	<div style="padding:10px">
		    ...
		    All fields with red asterisk (*) imply they must be provided</div>
		      <div>
		        <button onclick="javascript: handleButtonAction('cancelupdate'); return false;" name="createcorporateindividualStepThreebtn1" id="createcorporateindividualStepThreebtn1" class="btn btn-danger" style="float:left">Cancel</button>
				<button onclick="javascript: handleButtonAction('updatenow'); return false;" name="createcorporateindividualStepThreebtn2" id="createcorporateindividualStepThreebtn2" class="btn btn-success" style="float:right">Proceed to Update Company Staff Profile</button>
		      </div>
		</div>
