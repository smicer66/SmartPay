...
<portlet:actionURL var="portcreator" name="processAction">
	<portlet:param name="action"
		value="<%=PORTS_ACTION.UPDATE_NEW_PORT_ACTION.name()%>" />
</portlet:actionURL>
    ...
    <div class="panel panel-primary">
		...
		<div class="panel-body">
		    ...
		    <fieldset>
		      ...
		      <div style="padding-bottom:10px"> <strong>Name of Port:</strong>
		        <div>
		    ...
		    All fields with red asterisk (*) imply they must be provided</div>
		      <div>
		        <button name="createport" id="createport" class="btn btn-success">Save Port</button>
		      </div>
		    </fieldset>
		    </form>
		</div>
