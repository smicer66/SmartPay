...
<portlet:actionURL var="portcreator" name="processAction">
	<portlet:param name="action"
		value="<%=TAXTYPE_ACTION.CREATE_A_NEW_TAXTYPE_ACTION.name()%>" />
</portlet:actionURL>
...
<div style="padding:10px; width:900px"> 	
    <div class="panel panel-primary">
		<div class="panel-heading"><span style="color:white; font-weight: bold">Create A Tax Type</span></div>
		    ...
		    <form  id="portcreatorform" action="<%=portcreator%>" method="post" enctype="application/x-www-form-urlencoded">
		    	<div style="padding:10px;">
					  ...
					  <div style="padding-bottom:10px"> <strong>Tax Type Account Sort Code:</strong>
				        <div>
				          <input class="form-control" type="text" value="<%=portletState.getTaxTypeSortCode()==null ? "" : portletState.getTaxTypeSortCode() %>" name="taxTypeSortCode" id="taxTypeSortCode" placeholder="Provide A Tax Type Account Sort Code" />
				        </div>
				    ...
				    All fields with red asterisk (*) imply they must be provided</div>
				      <div>
				        <button name="createtaxtype" id="createtaxtype" class="btn btn-success">Create A New Tax Type</button>
				      </div>
		    	</div>
		    </form>
		</div>	  
