...
{
%>
<jsp:include page="/html/mandatepanelportlet/mandatepanel/createapanel_stepone.jsp" flush="" />
<%
}else if(portletState.getPortalUser()!=null && (portletState.getPortalUser().getRoleType().getRoleTypeName().equals(RoleTypeConstants.ROLE_TYPE_COMPANY_SUPER_ADMINISTRATOR)))
{
	if(portletState.getPortalUser().getCompany().getMandatePanelsOn().equals(Boolean.TRUE))
	{
%>
<jsp:include page="/html/mandatepanelportlet/mandatepanel/createapanel.jsp" flush="" />
<%
	}else
	{
	%>
