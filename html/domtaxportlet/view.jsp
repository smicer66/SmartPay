...
{
%>
<jsp:include page="/html/domtaxportlet/domtaxlisting.jsp" flush="" />
<%
}else
{
	...
	{
		%>
		You do not have a Tax Identification Number (TIN) set up. Request the bank to set up a Domiciliary Tax Account for you
		<%		
	}else
	{
		%>
